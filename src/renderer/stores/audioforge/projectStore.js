...
import { AudioForgeProjectService } from '../../../shared/audioforge/projectService';

export const useAudioForgeProjectStore = defineStore('audioforge-project', () => {
    // State
    ...
    const projectService = new AudioForgeProjectService();
